"""
Create function for doing test/valitate/test split
"""
...
def train_val_test_split(data, train_portion, val_portion, test_portion):
    ...
    train, non_train = train_test_split(data, train_size=train_input, test_size=non_train_input,
                               random_state=42)

    # Split the validation and test data
    val, test = train_test_split(non_train, train_size=val_input, test_size=test_input,
                               random_state=42)
